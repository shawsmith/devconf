...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; %F - frame name
   ;; %s - process status
   ;; %p - perceppnt of buffer above top of window, or Top, Bot or All
